...
type TaskParams struct {
	...
	} `json:"dependence,omitempty"`
	ConditionResult *struct {
		SuccessNode []map[string]interface{} `json:"successNode"`
		FailedNode  []map[string]interface{} `json:"failedNode"`
	} `json:"conditionResult,omitempty"`
	WaitStartTimeout map[string]interface{} `json:"waitStartTimeout,omitempty"`
	SwitchResult     *SwitchResult          `json:"switchResult,omitempty"`
}
